...
# ─────────────────────────────────────────────────────────────────────────────
# DirectML — sélection GPU discret
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Mixin commun LSTM / Transformer (PyTorch)
# ─────────────────────────────────────────────────────────────────────────────
...
class _TorchSequenceMixin:
    ...
    def _to_tensor(self, arr: np.ndarray) -> torch.Tensor:
        return torch.tensor(arr, dtype=torch.float32).to(self._get_device())
    ...
    def _train_loop(
        ...
        if best_state is not None:
            self.net.load_state_dict(
                {k: v.to(self._get_device()) for k, v in best_state.items()}
            )
...
# ─────────────────────────────────────────────────────────────────────────────
# TRANSFORMER (PyTorch — GPU DirectML RX 9070 XT)
# ─────────────────────────────────────────────────────────────────────────────
